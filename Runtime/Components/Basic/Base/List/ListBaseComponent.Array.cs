...
namespace UnityEngine.UI.Windows.Components {
    ...
    public partial class ListBaseComponent {
        ...
        public virtual async void SetItems<T, TItem, TClosure>(TItem[] list, System.Action<T, TClosure> onItem, TClosure closure, System.Action<TClosure> onComplete) where T : WindowComponent where TClosure : IListItemArrayClosureParameters<TItem> {
